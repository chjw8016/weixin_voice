...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxb9dec6186bf5dfac'),         // AppID
    'secret'  => env('WECHAT_SECRET', '37bf62b6940326765a5d55f4fcf0cad9'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'voice'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'aftJnfX88hAZf4K6716JM42XsjQDpXni3QEbGOv4jvr'),                    // EncodingAESKey
     ...
     */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', '/oauth_callback.php'),
     ],
